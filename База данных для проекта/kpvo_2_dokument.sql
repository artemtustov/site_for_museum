...
CREATE TABLE `dokument` (
  ...
  `Nazvanie_istochnika` varchar(45) DEFAULT NULL,
  `Fond` varchar(45) DEFAULT NULL,
  `Opis` varchar(45) DEFAULT NULL,
  `Delo` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `dokument` VALUES (1,'54654','Донесение о безвозвратных потерях','1944-10-12','43 А','58','18002','453');
